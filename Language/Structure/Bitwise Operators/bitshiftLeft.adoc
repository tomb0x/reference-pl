...
Jeśli wiesz, że nie stracisz bezpowrotnie żadnej informacji w trakcie przesuwania, łatwo wyobrazić sobie operator przesunięcia w lewo jako, mnożenie lewyego argumentu przez 2 podniesione do potęgi prawego argumentu. Na przykład, aby wygenerować potęgi liczby 2, można zastosować następujące wyrażenia:
